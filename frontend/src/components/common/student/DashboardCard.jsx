...
function DashboardCard({ title, value, change, positive, icon, iconBg, iconColor }) {
  return (
    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition duration-200">
      <div className="flex items-center justify-between mb-5">
        <div className={`w-12 h-12 rounded-2xl ${iconBg || "bg-blue-50"} ${iconColor || "text-blue-600"} flex items-center justify-center`}>
          {icon}
        </div>
        {change && (
          <span

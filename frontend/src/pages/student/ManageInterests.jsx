...
function ManageInterests() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg  p-8 bg-linear-to-tl from-white  to-blue-300">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {interestOptions.map((interest) => (
              <label
                key={interest}
                className="flex items-center gap-3 p-4  rounded-xl cursor-pointer hover:border-blue-500 transition"
              >
                <input
                  type="checkbox"
